            ...
            <div class="col-lg-12 col-md-12">
                ...
                <div id="create-news" class="card updates">
                    ...
                    <div id="create-box" class="show create-box card-body">
                        <form action="{{route('adpostEditBanker', ['id' => $post->id])}}" method="POST" id="create-new"
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label" for="form-avatar">@if($post->logo != "")
                                                {{substr($post->logo,0,strpos($post->logo,'?'))}} @else Choose file
                                                @endif </label>
                                        </div>
                                    </div>
                                    <img id="file-show" @if($post->logo != "")
                                    src="{{ asset('public/img/post/' .$post->logo) }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="form-promotion-txt" class="text-content form-control"
                                        name="promotion">{!!$post->promotion!!}</textarea>
                                </div>
                            </div>
                            <div class="line"></div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="form-comment-txt" class="text-content form-control"
                                        name="comment">{!!$post->comment!!}</textarea>
                                </div>
                            </div>
                            <div class="line"></div>
                            <div class="form-group row">
