      ...
      <div class="col-lg-12 col-md-12">
        ...
        <div id="create-news" class="card updates">
          ...
          <div id="create-box" class="show create-box card-body">
            <form action="{{route('adpostEditPost', ['id' => $post->id])}}" method="POST" id="create-new" class="form-create" enctype='multipart/form-data'>
              {{ csrf_field() }}
              <div class="form-group row">
                <label class="col-sm-2 form-control-label">Tên bài viết:</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="form-title" name="title" required="" value="{{$post->title}}">
                </div>
              </div>
              <div class="line"></div>
               <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="form-slug" name="slug" required="" value="{{$post->slug}}">
                </div>
              </div>
              <div class="line"></div>
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <div class="input-group">
                    ...
                    <div class="custom-file">
                      ...
                      <label class="custom-file-label" for="form-avatar">@if($post->cover != "") {{substr($post->cover,0,strpos($post->cover,'?'))}} @else Choose file @endif </label>
                    </div>
                  </div>
                  <img id="file-show" @if($post->cover != "") src="{{'/img/post/' .$post->cover}}" @else class="hidden" @endif >
                </div>
              </div>
              <div class="line"></div>
               <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="number" class="form-control" id="form-pos" name="pos" value="{{$post->pos}}">
                </div>
              </div>
              <div class="line"></div>
               <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="number" class="form-control" id="form-view" name="view" value="{{$post->view}}">
                </div>
              </div>
              <div class="line"></div>
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <textarea id="form-description-txt" class="text-content form-control" name="description" >{{$post->description}}</textarea>
                </div>
              </div>
              <div class="line"></div>
              ...
              <div class="content-post @if($post->type == 3) hidden @endif " >
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <textarea id="form-content-txt" class="text-content form-control" name="content">@if($post->type != 3){!! $post->content !!}@endif</textarea>
                  </div>
                  <script>
