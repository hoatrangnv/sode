<div class="col-md-4 col-12 sidebar">
        ...
        <div class="box-top pt-3">
            ...
            <div class="row mx-3">
                <div class="col-md-6 col-6 pl-0 text-center">
                    <img class="img img-fluid w-50 bg-dark" src="{{'public/img/post/' .$item->logo}}">
                </div>
    ...
    <!---->
    <div class="border-top mt-3 d-block d-md-none" style="margin-left: -15px;margin-right: -15px;"></div>
