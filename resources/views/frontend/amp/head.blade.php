...
.col-10,.col-12,.col-2,.col-3,.col-9,.col-md-10,.col-md-2,.col-md-3,.col-md-4,.col-md-6,.col-md-8,.col-md-9{position:relative;width:100%;min-height:1px;padding-right:15px;padding-left:15px;}
...
html body .navbar-expand-lg .navbar-collapse{display:-ms-flexboxdisplay:flex-ms-flex-preferred-size:auto;flex-basis:auto;}
...
html body .justify-content-end{-ms-flex-pack:endjustify-content:flex-end}
...
@media print{
html body *,::after,::before{text-shadow:nonebox-shadow:none}
a:not(.btn){text-decoration:underline;}
thead{display:table-header-group;}
img,tr{page-break-inside:avoid;}
h2,h3,p{orphans:3;widows:3;}
h2,h3{page-break-after:avoid;}
html body body{min-width:992px}
...
body header .navbar{background-color:#fd5900;}
body header .navbar .img-logo{width:200px;}
...
body main .content .table-content tbody .btn_rate{color:#fd5900;font-weight:600;padding:10px 27px;text-transform:uppercase;background-color:#fff;}
body main .content .table-content tbody .stt{background-color:#fd5900;padding:15px 0px;margin:0px;color:#fff;font-weight:600;font-size:18px;}
...
body main .news .title h2 a{color:#fd5900;text-decoration:none;font-family:'Roboto Condensed', sans-serif;}
...
body main .news .content-news .title-news a:hover{color:#fd5900;text-decoration:none;}
...
body main .news-footbal .sidebar .title-sidebar h2 a{color:#fd5900;text-decoration:none;font-family:'Roboto Condensed', sans-serif;}
body main .news-footbal .ft-news h3{font-size:22px;font-family:'Roboto Condensed', sans-serif;}
html body body main .news-footbal .ft-news a:hover{text-decoration:none;color:#fd5900}
...
body main .news-footbal .ft-news .title h2 a{color:#fd5900;text-decoration:none;font-family:'Roboto Condensed', sans-serif;}
...
body footer .footer .dmca .des{color:#7f7f7f;font-weight:500;}
@media (max-width: 576px){
body p{font-size:15px;}
body header .btn-menu{margin-right:-10px;}
html body body header .btn-menu:active{border:none}
body main{top:50px;}
...
body main .sidebar .box-sidebar .title-sidebar h2{font-size:20px;color:#fd5900;font-weight:600;border-left:5px solid;text-align:left;padding-left:5px;}
...
@font-face{font-family:'Roboto Condensed';font-style:italic;font-weight:700;src:local('Roboto Condensed Bold Italic'), local('RobotoCondensed-BoldItalic'), url(https://fonts.gstatic.com/s/robotocondensed/v18/ieVg2ZhZI2eCN5jzbjEETS9weq8-19eDtCYoYdNZUSdy4ehI.woff2) format('woff2');unicode-range:U+1F00-1FFF;}
@font-face{font-family:'Roboto Condensed';font-style:italic;font-weight:700;src:local('Roboto Condensed Bold Italic'), local('RobotoCondensed-BoldItalic'), url(https://fonts.gstatic.com/s/robotocondensed/v18/ieVg2ZhZI2eCN5jzbjEETS9weq8-19eDtCYobtNZUSdy4ehI.woff2) format('woff2');unicode-range:U+0370-03FF;}
@font-face{font-family:'Roboto Condensed';font-style:italic;font-weight:700;src:local('Roboto Condensed Bold Italic'), local('RobotoCondensed-BoldItalic'), url(https://fonts.gstatic.com/s/robotocondensed/v18/ieVg2ZhZI2eCN5jzbjEETS9weq8-19eDtCYoYtNZUSdy4ehI.woff2) format('woff2');unicode-range:U+0102-0103, U+0110-0111, U+1EA0-1EF9, U+20AB;}
...
@font-face{font-family:'Roboto Condensed';font-style:normal;font-weight:400;src:local('Roboto Condensed'), local('RobotoCondensed-Regular'), url(https://fonts.gstatic.com/s/robotocondensed/v18/ieVl2ZhZI2eCN5jzbjEETS9weq8-19a7DQk6YvNkeg.woff2) format('woff2');unicode-range:U+0400-045F, U+0490-0491, U+04B0-04B1, U+2116;}
@font-face{font-family:'Roboto Condensed';font-style:normal;font-weight:400;src:local('Roboto Condensed'), local('RobotoCondensed-Regular'), url(https://fonts.gstatic.com/s/robotocondensed/v18/ieVl2ZhZI2eCN5jzbjEETS9weq8-1967DQk6YvNkeg.woff2) format('woff2');unicode-range:U+1F00-1FFF;}
@font-face{font-family:'Roboto Condensed';font-style:normal;font-weight:400;src:local('Roboto Condensed'), local('RobotoCondensed-Regular'), url(https://fonts.gstatic.com/s/robotocondensed/v18/ieVl2ZhZI2eCN5jzbjEETS9weq8-19G7DQk6YvNkeg.woff2) format('woff2');unicode-range:U+0370-03FF;}
@font-face{font-family:'Roboto Condensed';font-style:normal;font-weight:400;src:local('Roboto Condensed'), local('RobotoCondensed-Regular'), url(https://fonts.gstatic.com/s/robotocondensed/v18/ieVl2ZhZI2eCN5jzbjEETS9weq8-1927DQk6YvNkeg.woff2) format('woff2');unicode-range:U+0102-0103, U+0110-0111, U+1EA0-1EF9, U+20AB;}
...
@font-face{font-family:'Roboto Condensed';font-style:normal;font-weight:700;src:local('Roboto Condensed Bold'), local('RobotoCondensed-Bold'), url(https://fonts.gstatic.com/s/robotocondensed/v18/ieVi2ZhZI2eCN5jzbjEETS9weq8-32meGCgYb9lecyVC4A.woff2) format('woff2');unicode-range:U+1F00-1FFF;}
@font-face{font-family:'Roboto Condensed';font-style:normal;font-weight:700;src:local('Roboto Condensed Bold'), local('RobotoCondensed-Bold'), url(https://fonts.gstatic.com/s/robotocondensed/v18/ieVi2ZhZI2eCN5jzbjEETS9weq8-32meGCcYb9lecyVC4A.woff2) format('woff2');unicode-range:U+0370-03FF;}
@font-face{font-family:'Roboto Condensed';font-style:normal;font-weight:700;src:local('Roboto Condensed Bold'), local('RobotoCondensed-Bold'), url(https://fonts.gstatic.com/s/robotocondensed/v18/ieVi2ZhZI2eCN5jzbjEETS9weq8-32meGCsYb9lecyVC4A.woff2) format('woff2');unicode-range:U+0102-0103, U+0110-0111, U+1EA0-1EF9, U+20AB;}
